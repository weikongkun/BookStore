								...
								<table width="100%" border="0" cellspacing="0">
									...
									<tr>
										...
										<c:forEach items="${order.orderItems }" var="o" varStatus="vs">
											...
											<c:set var="count" value="${count+o.p.price*o.buynum }"></c:set>
										</c:forEach>
											...
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath }/confirmOrder?orderid=${order.id}&money=${order.money}"><img src="images/gif53_029.gif" width="204"
